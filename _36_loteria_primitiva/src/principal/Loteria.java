...
public class Loteria {
	//generar combinacion de loteria primitiva(6 numeros aleatorios no repetidos,entre 1 y 49)
	public static void main(String[] args) {
        ...
        while(contador<6) {
        	...
        	if(!repetido(numeroGenerado, combinacion, contador)) {
        		combinacion [contador]=numeroGenerado;//añadimos el número en la posicion que le corresponde en el array
        		contador++;
        	}
